...
fprintf('%20s*| cases: %5s percent | rate: %5s | accel: %5s | death: %5s \n',Name,num2str((100*cases(end)./pop),3),num2str(floor(Dcases(end)),6),num2str(floor(DDcases(end)),6), num2str(floor(deaths(end)),6));
